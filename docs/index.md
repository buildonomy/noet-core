...
**[Documentation as a Dependency Graph](design/core/dag_model.md)** — Why noet models
...
- [Query Model](design/core/query_model.md) — Formal query algebra: traversal, composition, scoring, instruments
- [BeliefBase Architecture](design/core/beliefbase_architecture.md) — Detailed technical specification
...
### [dag_model.md](design/core/dag_model.md)
...
### [query_model.md](design/core/query_model.md)
...
### [beliefbase_architecture.md](design/core/beliefbase_architecture.md)
