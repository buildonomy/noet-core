...
> The corpus-wide search mode added to the traceability panel in Issue 70 covers the core
> use case of this issue — filtering and querying the corpus interactively — without a
> separate query-builder panel. The Simple/Advanced/Raw mode progression described here is
> replaced by the Search row source + field-scoped query syntax (`title:`, `schema:`,
> `kind:`, `AND`, `NOT`) implemented in Issue 70 Phase 4. No further action required.
...
### 2026-08-27: Further superseded; API drift
