...
- Single `CODECS: HashMap<_, CodecFactory>` map described here → superseded by two-registry dispatch (`CODECS`, `WALK_CODECS`, `CLAIM_MAP`); see Issue 68 and `docs/design/core/beliefbase_architecture.md` §3.2/§3.6.
