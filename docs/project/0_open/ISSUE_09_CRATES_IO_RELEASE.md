...
7. **Community Announcements** (1 day)
   ...
   - [ ] Post to /r/rust:
     - Title: "[Release] noet-core 0.1.0 - Multigraph knowledge management with three-way sync"
...
**noet-core** is a multigraph-based knowledge management library that maintains bidirectional synchronization between markdown documents and a queryable graph.
...
noet-core provides a multigraph-based system that keeps markdown documents synchronized with a queryable graph database. Think of it as the plumbing for building tools like Obsidian, Roam Research, or custom documentation systems.
